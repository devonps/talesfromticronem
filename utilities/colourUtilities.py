...
HAN = RGB(63, 0, 255)
LIGHT_AMBER = RGB(255, 207, 63)
LIGHT_AZURE = RGB(63, 159, 255)
LIGHT_BLUE = RGB(63, 63, 255)
LIGHT_CHARTREUSE = RGB(159, 255, 63)
LIGHT_CRIMSON = RGB(255, 63, 111)
LIGHT_CYAN = RGB(63, 255, 255)
LIGHT_FLAME = RGB(255, 111, 63)
LIGHT_FUCHSIA = RGB(255, 63, 255)
LIGHT_GRAY = RGB(159, 159, 159)
LIGHT_GREEN = RGB(63, 255, 63)
LIGHT_GREY = RGB(159, 159, 159)
LIGHT_HAN = RGB(111, 63, 255)
LIGHT_LIME = RGB(207, 255, 63)
LIGHT_MAGENTA = RGB(255, 63, 207)
LIGHT_ORANGE = RGB(255, 159, 63)
LIGHT_PINK = RGB(255, 63, 159)
LIGHT_PURPLE = RGB(207, 63, 255)
LIGHT_RED = RGB(255, 63, 63)
LIGHT_SEA = RGB(63, 255, 159)
LIGHT_SEPIA = RGB(158, 134, 100)
LIGHT_SKY = RGB(63, 207, 255)
LIGHT_TURQUOISE = RGB(63, 255, 207)
LIGHT_VIOLET = RGB(159, 63, 255)
LIGHT_YELLOW = RGB(255, 255, 63)
LIGHTER_AMBER = RGB(255, 223, 127)
LIGHTER_AZURE = RGB(127, 191, 255)
LIGHTER_BLUE = RGB(127, 127, 255)
LIGHTER_CHARTREUSE = RGB(191, 255, 127)
LIGHTER_CRIMSON = RGB(255, 127, 159)
LIGHTER_CYAN = RGB(127, 255, 255)
LIGHTER_FLAME = RGB(255, 159, 127)
LIGHTER_FUCHSIA = RGB(255, 127, 255)
LIGHTER_GRAY = RGB(191, 191, 191)
LIGHTER_GREEN = RGB(127, 255, 127)
LIGHTER_GREY = RGB(191, 191, 191)
LIGHTER_HAN = RGB(159, 127, 255)
LIGHTER_LIME = RGB(223, 255, 127)
LIGHTER_MAGENTA = RGB(255, 127, 223)
LIGHTER_ORANGE = RGB(255, 191, 127)
LIGHTER_PINK = RGB(255, 127, 191)
LIGHTER_PURPLE = RGB(223, 127, 255)
LIGHTER_RED = RGB(255, 127, 127)
LIGHTER_SEA = RGB(127, 255, 191)
LIGHTER_SEPIA = RGB(191, 171, 143)
LIGHTER_SKY = RGB(127, 223, 255)
LIGHTER_TURQUOISE = RGB(127, 255, 223)
LIGHTER_VIOLET = RGB(191, 127, 255)
LIGHTER_YELLOW = RGB(255, 255, 127)
...
colors['azure'] = AZURE
colors['brass'] = BRASS
colors['celadon'] = CELADON
colors['chartreuse'] = CHARTREUSE
colors['copper'] = COPPER
colors['cyan'] = CYAN
colors['dark_amber'] = DARK_AMBER
colors['dark_azure'] = DARK_AZURE
colors['dark_blue'] = DARK_BLUE
colors['dark_chartreuse'] = DARK_CHARTREUSE
colors['dark_crimson'] = DARK_CRIMSON
colors['dark_cyan'] = DARK_CYAN
colors['dark_flame'] = DARK_FLAME
colors['dark_fuchsia'] = DARK_FUCHSIA
colors['dark_gray'] = DARK_GRAY
colors['dark_green'] = DARK_GREEN
colors['dark_grey'] = DARK_GREY
colors['dark_han'] = DARK_HAN
colors['dark_lime'] = DARK_LIME
colors['dark_magenta'] =  DARK_MAGENTA
colors['dark_orange'] = DARK_ORANGE
colors['dark_pink'] = DARK_PINK
colors['dark_purple'] = DARK_PURPLE
colors['dark_red'] = DARK_RED
colors['dark_sea'] = DARK_SEA
colors['dark_sepia'] = DARK_SEPIA
colors['dark_sky'] = DARK_SKY
colors['dark_turquoise'] = DARK_TURQUOISE
colors['dark_violet'] = DARK_VIOLET
colors['dark_yellow'] = DARK_YELLOW
colors['darker_amber'] = DARKER_AMBER
colors['darker_azure'] = DARKER_AZURE
colors['darker_blue'] = DARKER_BLUE
colors['darker_chartreuse'] = DARKER_CHARTREUSE
colors['darker_crimson'] = DARKER_CRIMSON
colors['darker_cyan'] = DARKER_CYAN
colors['darker_flame'] = DARKER_FLAME
colors['darker_fuchsia'] = DARKER_FUCHSIA
colors['darker_gray'] = DARKER_GRAY
colors['darker_green'] = DARKER_GREEN
colors['darker_grey'] = DARKER_GREY
colors['darker_han'] = DARKER_HAN
colors['darker_lime'] = DARKER_LIME
colors['darker_magenta'] = DARKER_MAGENTA
colors['darker_orange'] = DARKER_ORANGE
colors['darker_pink'] = DARKER_PINK
colors['darker_purple'] = DARKER_PURPLE
colors['darker_red'] = DARKER_RED
colors['darker_sea'] = DARKER_SEA
colors['darker_sepia'] = DARKER_SEPIA
colors['darker_sky'] = DARKER_SKY
colors['darker_turquoise'] = DARKER_TURQUOISE
colors['darker_violet'] = DARKER_VIOLET
colors['darker_yellow'] = DARKER_YELLOW
colors['darkest_amber'] = DARKEST_AMBER
colors['darkest_azure'] = DARKEST_AZURE
colors['darkest_blue'] = DARKEST_BLUE
colors['darkest_chartreuse'] = DARKEST_CHARTREUSE
colors['darkest_crimson'] = DARKEST_CRIMSON
colors['darkest_cyan'] = DARKEST_CYAN
colors['darkest_flame'] = DARKEST_FLAME
colors['darkest_fuchsia'] = DARKEST_FUCHSIA
colors['darkest_gray'] = DARKEST_GRAY
colors['darkest_green'] = DARKEST_GREEN
colors['darkest_grey'] = DARKEST_GREY
colors['darkest_han'] = DARKEST_HAN
colors['darkest_lime'] = DARKEST_LIME
colors['darkest_magenta'] = DARKEST_MAGENTA
colors['darkest_orange'] = DARKEST_ORANGE
colors['darkest_pink'] = DARKEST_PINK
colors['darkest_purple'] = DARKEST_PURPLE
colors['darkest_red'] = DARKEST_RED
colors['darkest_sea'] = DARKEST_SEA
colors['darkest_sepia'] = DARKEST_SEPIA
colors['darkest_sky'] = DARKEST_SKY
colors['darkest_turquoise'] = DARKEST_TURQUOISE
colors['darkest_violet'] = DARKEST_VIOLET
colors['darkest_yellow'] = DARKEST_YELLOW
colors['desaturated_amber'] = DESATURATED_AMBER
colors['desaturated_azure'] = DESATURATED_AZURE
colors['desaturated_blue'] = DESATURATED_BLUE
colors['desaturated_chartreuse'] =  DESATURATED_CHARTREUSE
colors['desaturated_crimson'] = DESATURATED_CRIMSON
colors['desaturated_cyan'] = DESATURATED_CYAN
colors['desaturated_flame'] = DESATURATED_FLAME
colors['desaturated_fuchsia'] = DESATURATED_FUCHSIA
colors['desaturated_green'] = DESATURATED_GREEN
colors['desaturated_han'] = DESATURATED_HAN
colors['desaturated_lime'] = DESATURATED_LIME
colors['desaturated_magenta'] = DESATURATED_MAGENTA
colors['desaturated_orange'] = DESATURATED_ORANGE
colors['desaturated_pink'] = DESATURATED_PINK
colors['desaturated_purple'] = DESATURATED_PURPLE
colors['desaturated_red'] = DESATURATED_RED
colors['desaturated_sea'] = DESATURATED_SEA
colors['desaturated_sky'] = DESATURATED_SKY
colors['desaturated_turquoise'] = DESATURATED_TURQUOISE
colors['desaturated_violet'] = DESATURATED_VIOLET
colors['desaturated_yellow'] = DESATURATED_YELLOW
colors['flame'] = FLAME
...
colors['grey'] = GREY
colors['han'] = HAN
colors['light_amber'] = LIGHT_AMBER
colors['light_azure'] = LIGHT_AZURE
colors['light_blue'] = LIGHT_BLUE
colors['light_chartreuse'] = LIGHT_CHARTREUSE
colors['light_crimson'] = LIGHT_CRIMSON
colors['light_cyan'] = LIGHT_CYAN
colors['light_flame'] = LIGHT_FLAME
colors['light_fuchsia'] = LIGHT_FUCHSIA
colors['light_gray'] = LIGHT_GRAY
colors['light_green'] = LIGHT_GREEN
colors['light_grey'] = LIGHT_GREY
colors['light_han'] = LIGHT_HAN
colors['light_lime'] = LIGHT_LIME
colors['light_magenta'] = LIGHT_MAGENTA
colors['light_orange'] = LIGHT_ORANGE
colors['light_pink'] = LIGHT_PINK
colors['light_purple'] = LIGHT_PURPLE
colors['light_red'] = LIGHT_RED
colors['light_sea'] = LIGHT_SEA
colors['light_sepia'] = LIGHT_SEPIA
colors['light_sky'] = LIGHT_SKY
colors['light_turquoise'] = LIGHT_TURQUOISE
colors['light_violet'] = LIGHT_VIOLET
colors['light_yellow'] = LIGHT_YELLOW
colors['lighter_amber'] = LIGHTER_AMBER
colors['lighter_azure'] = LIGHTER_AZURE
colors['lighter_blue'] = LIGHTER_BLUE
colors['lighter_chartreuse'] = LIGHTER_CHARTREUSE
colors['lighter_crimson'] = LIGHTER_CRIMSON
colors['lighter_cyan'] = LIGHTER_CYAN
colors['lighter_flame'] = LIGHTER_FLAME
colors['lighter_fuchsia'] = LIGHTER_FUCHSIA
colors['lighter_gray'] = LIGHTER_GRAY
colors['lighter_green'] = LIGHTER_GREEN
colors['lighter_grey'] = LIGHTER_GREY
colors['lighter_han'] = LIGHTER_HAN
colors['lighter_lime'] = LIGHTER_LIME
colors['lighter_magenta'] = LIGHTER_MAGENTA
colors['lighter_orange'] = LIGHTER_ORANGE
colors['lighter_pink'] = LIGHTER_PINK
colors['lighter_purple'] = LIGHTER_PURPLE
colors['lighter_red'] = LIGHTER_RED
colors['lighter_sea'] = LIGHTER_SEA
colors['lighter_sepia'] = LIGHTER_SEPIA
colors['lighter_sky'] = LIGHTER_SKY
colors['lighter_turquoise'] = LIGHTER_TURQUOISE
colors['lighter_violet'] = LIGHTER_VIOLET
colors['lighter_yellow'] = LIGHTER_YELLOW
colors['lightest_amber'] = LIGHTEST_AMBER
colors['lightest_azure'] = LIGHTEST_AZURE
colors['lightest_blue'] = LIGHTEST_BLUE
colors['lightest_chartreuse'] = LIGHTEST_CHARTREUSE
colors['lightest_crimson'] = LIGHTEST_CRIMSON
colors['lightest_cyan'] = LIGHTEST_CYAN
colors['lightest_flame'] = LIGHTEST_FLAME
colors['lightest_fuchsia'] = LIGHTEST_FUCHSIA
colors['lightest_gray'] = LIGHTEST_GRAY
colors['lightest_green'] = LIGHTEST_GREEN
colors['lightest_grey'] = LIGHTEST_GREY
colors['lightest_han'] = LIGHTEST_HAN
colors['lightest_lime'] = LIGHTEST_LIME
colors['lightest_magenta'] = LIGHTEST_MAGENTA
colors['lightest_orange'] = LIGHTEST_ORANGE
colors['lightest_pink'] = LIGHTEST_PINK
colors['lightest_purple'] = LIGHTEST_PURPLE
colors['lightest_red'] = LIGHTEST_RED
colors['lightest_sea'] = LIGHTEST_SEA
colors['lightest_sepia'] = LIGHTEST_SEPIA
colors['lightest_sky'] = LIGHTEST_SKY
colors['lightest_turquoise'] = LIGHTEST_TURQUOISE
colors['lightest_violet'] = LIGHTEST_VIOLET
colors['lightest_yellow'] = LIGHTEST_YELLOW
colors['lime'] = LIME
colors['peach'] = PEACH
colors['red'] = RED
colors['sea'] = SEA
