...
# health, mana, and F1 bar settings
H_BAR_X = MSG_PANEL_WIDTH
H_BAR_Y = MSG_PANEL_START_Y

# all bars
ALL_BAR_WIDTH = 30
ALL_BAR_RIGHT_SIDE = 1 + H_BAR_X + ALL_BAR_WIDTH

BCC_WIDTH = 10
BCC_BAR_RIGHT_SIDE = 1 + BCC_WIDTH + MSG_PANEL_WIDTH

V_BAR_X = VIEWPORT_WIDTH
V_BAR_Y = (VIEWPORT_HEIGHT - ALL_BAR_WIDTH) - 3
V_BAR_D = V_BAR_Y + ALL_BAR_WIDTH + 1
