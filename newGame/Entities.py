...
class NewEntity:
    ...
    def create_base_entity(gameworld, game_config, npc_glyph, posx, posy, this_entity):
        ...
        Entity.set_min_max_preferred_ranges(entity_id=entity_id, min_range='medium', max_range='long',
    ...
    def choose_weapons(weapon_file_option_both, weapon_file_option_main, weapon_file_option_off, entity_id, gameworld,
        ...
        if equipped_weapons:
            ...
            NewEntity.generate_sample_spells_to_be_loaded(created_weapon_entity=created_weapon_entity, entity_id=entity_id, gameworld=gameworld, game_config=game_config)
    ...
    def select_main_hand_weapon(main_hand, selected_class, game_config):
        ...
        if main_hand == 'random':
            available_weapons = NewEntity.build_available_weapons(selected_class=selected_class, game_config=game_config)
            ...
            if identifer == cellid:
                ...
                for npc in npcs_file['npc']:
                    if npc_name == npc['name']:
                        ...
                        # ---------------------------------------------
                        Entity.add_spells_to_spell_bar_based_on_equipped_jewellery(gameworld=gameworld,
                                                                                   entity_id=entity_id)
                        ...
                        # --------------------------------------
                        Entity.choose_weapons(weapon_file_option_both=weapon_file_option_both,
                                              weapon_file_option_main=weapon_file_option_main,
                                              weapon_file_option_off=weapon_file_option_off, entity_id=entity_id,
                                              gameworld=gameworld, game_config=game_config)
                        ...
                        heal_spell_entity = spellHelp.SpellUtilities.get_class_heal_spell(gameworld=gameworld,
                                                                                          player_entity=entity_id)
                        spellHelp.SpellUtilities.set_spellbar_slot(gameworld=gameworld, spell_entity=heal_spell_entity,
                                                                   slot=5,
                                                                   player_entity=entity_id)
                        ...
                        # --- SET COMBAT ROLE -
                        # --------------------------------------
                        mobileHelp.MobileUtilities.set_enemy_combat_role(entity=entity_id, gameworld=gameworld,
                                                                         value='none')
                        ...
                        mobileHelp.MobileUtilities.set_mobile_ai_level(gameworld=gameworld, entity=entity_id,
                                                                       value=entity_ai)
                        ...
                        mobileHelp.MobileUtilities.set_mobile_description(gameworld=gameworld, entity=entity_id,
                                                                          value=npc_desc)
                        mobileHelp.MobileUtilities.set_mobile_glyph(gameworld=gameworld, entity=entity_id,
                                                                    value=npc_glyph)
                        mobileHelp.MobileUtilities.set_mobile_fg_render_colour(gameworld=gameworld, entity=entity_id,
                                                                               value=npc_fg)
                        mobileHelp.MobileUtilities.set_mobile_bg_render_colour(gameworld=gameworld, entity=entity_id,
                        ...
                        mobileHelp.MobileUtilities.set_mobile_position(gameworld=gameworld, entity=entity_id, posx=posx,
                                                                       posy=posy)
                        mobileHelp.MobileUtilities.set_mobile_derived_personality(gameworld=gameworld, entity=entity_id)
                        mobileHelp.MobileUtilities.set_mobile_type(gameworld=gameworld, entity=entity_id,
                                                                   value=npc_type)

                        # calculate derived stats
                        armourManagement.ArmourUtilities.set_mobile_derived_armour_attribute(gameworld=gameworld,
                                                                                             entity=entity_id)
    ...
    def create_enemy_role(gameworld, game_config, posx, posy, enemy_role):
        ...
        for role in role_file['roles']:
            if role['id'] == enemy_role:
                ...
                # --- CREATE WEAPONSET ----------------
                # -------------------------------------
                Entity.choose_weapons(weapon_file_option_both=weapon_both_hands,
                                      weapon_file_option_main=weapon_main_hand,
